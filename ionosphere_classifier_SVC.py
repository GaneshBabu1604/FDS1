# -*- coding: utf-8 -*-
"""
Created on Fri Aug 14 11:41:55 2020

Support vector machine learning code to classify radio observations of the 
...
# Establish a blank slate Support Vector Classifier
model = SVC()
